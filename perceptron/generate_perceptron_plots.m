...
answers{1} = ['a.) The passive aggressive update strategy converges much quicker close the correct solution compared to a constant update rate.' ...
    'b.) The constate learning rate update strategy has the lowest training error.' ...
    'c.) The passive aggressive update strategy has the lowest test error.' ...
    'd.) The passive aggressive update strategy has a test error of 3.83% while the linear SVM has a test error of 3.28%. So overall the linear SVM does perform slightly better.'];
